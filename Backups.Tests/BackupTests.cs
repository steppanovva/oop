...
namespace Backups.Tests
{
    ...
    public class BackupTests
    {
        ...
        public void CreateRestorePointsWithSplitStorage_RestorePointsAreCreated()
        {
            ...
            var jobObject1 = new JobObject("C:\\GitHub\\steppanovva\\Backups\\RootRepository\\1.txt", "1.txt");
            var jobObject2 = new JobObject("C:\\GitHub\\steppanovva\\Backups\\RootRepository\\2.txt", "2.txt");
            var jobObject3 = new JobObject("C:\\GitHub\\steppanovva\\Backups\\RootRepository\\3.txt", "3.txt");
